...
## Changelog
- 2026-02-16: Strengthened theme/extension manifest validation to enforce safe bundle-relative entry/template paths (no traversal/absolute/null-byte paths).
